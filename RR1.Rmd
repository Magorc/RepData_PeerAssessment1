...
###Conclusions###
Since the Interval with maximum average is `r I(maxint)`, and each interval is approximatly 3 minutes, we can conclude that the highest amount of steps is likely to occur around 8:30 am.
